...
def get_user_state(context: ContextTypes.DEFAULT_TYPE) -> UserState:
    """
    Получает текущее состояние пользователя из context.user_data.

    Args:
        context (ContextTypes.DEFAULT_TYPE): _description_

    Returns:
        UserState: _description_
    """
...
def set_user_state(context: ContextTypes.DEFAULT_TYPE, state: UserState) -> None:
    ...
    Args:
        ...
        state (UserState): Новое состояние пользователя.
    """
...
def reset_user_state(context: ContextTypes.DEFAULT_TYPE) -> None:
    """
    Сбрасывает состояние пользователя, устанавливая его в UserState.MAIN_MENU.
